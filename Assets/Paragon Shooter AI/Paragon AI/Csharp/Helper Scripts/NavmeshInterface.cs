...
public class NavmeshInterface : MonoBehaviour
{
    ...
    public virtual bool ReachedDestination(){
    	return (agent.remainingDistance != Mathf.Infinity && agent.pathStatus == UnityEngine.AI.NavMeshPathStatus.PathComplete && agent.remainingDistance <= 0 && !agent.pathPending);
    }
